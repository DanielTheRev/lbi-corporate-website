...
const ProjectCard: React.FC<Props> = ({ project, section }) => {
	...
	return (
		<Link
			...
			className='flex flex-col  items-center bg-white border border-gray-200 rounded-lg shadow w-full md:flex-row md:max-w-xl hover:bg-gray-100'>
			<Image
			...
			<div className='flex flex-col w-full p-4 overflow-hidden'>
				...
				<p className='mb-3 w-full text-xs md:text-sm font-normal text-gray-700 line-clamp-2'>
					{ProjectDescription}
				</p>
			</div>
		</Link>
