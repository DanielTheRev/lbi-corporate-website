...
const TrabajoPage = async ({ params: { id, section } }: Params) => {
	...
	return (
		<section className='flex flex-col md:flex-row w-full h-full text-white p-2 mt-10 overflow-hidden'>
			<header className='flex flex-col h-full justify-center items-center w-full md:p-3 animate-fade-up animate-duration-[500ms]'>
				...
				<p className='w-full md:max-w-[90%] h-full bg-neutral-200/50 rounded text-xs md:text-base text-slate-600 whitespace-pre-line text-pretty p-1 mb-3 md:px-2 md:py-4'>
