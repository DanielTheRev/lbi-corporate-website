...
const HomeBanner = async () => {
	...
	return (
		<section className='relative w-full h-full overflow-x-hidden p-1 animate-fade-down animate-duration-[500ms] text-white/90'>
			<Slider data={info} />

			<header className='flex w-full max-w-[1200px] mx-auto py-3 my-6 justify-start items-center'>
				<h2 className='text-4xl text-balance text-emerald-600'>Nuestras últimas obras</h2>
			</header>
